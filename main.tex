...
Desde o seu lançamento em novembro de 2020, o PIX tem ganhado uma adoção impressionante em todo o Brasil. Os usuários foram rápidos em aderir a esse novo meio de pagamento, reconhecendo os benefícios oferecidos em comparação aos métodos tradicionais, como boletos bancários e transferências TED/DOC. A possibilidade de realizar transações instantâneas, sem limitações de horário ou dias úteis, e com baixos custos tem impulsionado a utilização do PIX por empresas, estabelecimentos comerciais e pessoas físicas \cite{alexandre_rebêlo_ferreira_2022}.
...
\subsection{Desempenho exigido para um sistema de pagamentos instantâneos}  \label{sec:firstpage}
